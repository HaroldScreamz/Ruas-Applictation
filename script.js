...
function displayHands() {
    if (splitHandActive) {
        document.getElementById('player-hand').innerHTML = `${handToHTML(playerHand)} <br> <br> <br> </br><br> </br><br> </br><br> </br><br> </br><br> </br><br> </br><br> </br></br></br> ${handToHTML(playerHand2)}`;
    } else {
